...
{
    public class TrainTypeTaskDAL
    {
         private static Hashtable _ormTable;
        private int _recordCount = 0;

        static TrainTypeTaskDAL()
        {
        ...
        public void AddTrainTypeTask(TrainTypeTask obj)
        {
            Database db = DatabaseFactory.CreateDatabase();

            string sqlCommand = "USP_TRAIN_TYPE_TASK_I";
        ...
        public void UpdateTrainTypeTask(TrainTypeTask obj)
        {
            Database db = DatabaseFactory.CreateDatabase();

            string sqlCommand = "USP_TRAIN_TYPE_TASK_U";
            DbCommand dbCommand = db.GetStoredProcCommand(sqlCommand);
        ...
        public void DelTrainTypeTask(int trainTypeID,int paperID)
        {
            ...
            string sqlCommand = "USP_TRAIN_TYPE_TASK_D";
            DbCommand dbCommand = db.GetStoredProcCommand(sqlCommand);
        ...
        {
            IList<TrainTypeTask> objList = new List<TrainTypeTask>();

            Database db = DatabaseFactory.CreateDatabase();

            string sqlCommand = "USP_TRAIN_TYPE_TASK_G";
            DbCommand dbCommand = db.GetStoredProcCommand(sqlCommand);
            ...
            using (IDataReader dataReader = db.ExecuteReader(dbCommand))
            {
                ...
                {
                    TrainTypeTask obj = CreateModelObject(dataReader);
        ...
        public static TrainTypeTask CreateModelObject(IDataReader dataReader)
        {
            return new TrainTypeTask(
