<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TJ_EmployeePrize.aspx.cs" Inherits="RailExamWebApp.RandomExamTai.TJ_EmployeePrize" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>各单位技能竞赛统计</title>
    <style type="text/css">
 #Grid th{  height:100%;
...
//            }
          ...
          function exportTemplate()
	      {
	      	...
	      	var ret = window.showModalDialog("TJ_ExportTemplate.aspx?type=EmployeePrize&math="+Math.random(), '', 'help:no;status:no;dialogWidth:320px;dialogHeight:30px;');
