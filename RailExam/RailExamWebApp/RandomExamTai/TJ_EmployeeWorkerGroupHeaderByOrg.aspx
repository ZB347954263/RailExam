<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TJ_EmployeeWorkerGroupHeaderByOrg.aspx.cs"
    Inherits="RailExamWebApp.TJ_EmployeeWorkerGroupHeaderByOrg" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>各单位班组长人数统计</title>
    <style type="text/css">
 #Grid th{  height:100%;
  ...
  function selectCol(obj) {
        ...
        function ShowDetail(stationName, colIndex, cellValue)
        {
          ...
          function exportTemplate()
	      {
	      	...
	      	var ret = window.showModalDialog("TJ_ExportTemplate.aspx?type=EmployeeWorkerGroupHeaderByOrg&math="+Math.random(), '', 'help:no;status:no;dialogWidth:320px;dialogHeight:30px;');
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="Grid" runat="server" Width="100%" CssClass="Grid" OnRowCreated="Grid_RowCreated"
                AllowPaging="True" OnPageIndexChanging="Grid_PageIndexChanging" PageSize="18"
