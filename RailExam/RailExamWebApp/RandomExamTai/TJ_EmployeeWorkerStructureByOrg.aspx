<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TJ_EmployeeWorkerStructureByOrg.aspx.cs"
    Inherits="RailExamWebApp.RandomExamTai.TJ_EmployeeWorkerStructureByOrg" %>

 
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"> 
 <title>各单位工人结构统计</title>
<style type="text/css">
 #Grid th{  height:100%;
  ...
  function selectCol(obj) {
   ...
   function exportTemplate()
   	...
   	var techCount = document.getElementById("hfTechCount").value;
	      	...
	      	var ret = window.showModalDialog("TJ_ExportTemplate.aspx?type=EmployeeWorkerStructureByOrg&eduCount="+deuCount+"&techCount="+techCount+"&math="+Math.random(),
...
<body>
    <form id="form1" runat="server">
      <div style="text-align: right;">
        ...
        <div>
          <asp:GridView ID="Grid" runat="server"  Width="100%"  AllowPaging="true" PageSize="18"  CssClass="Grid"  
