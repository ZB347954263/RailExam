<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MultiSelectPostOne.aspx.cs"
    Inherits="RailExamWebApp.Common.MultiSelectPostOne" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
       ...
       nodeIDs=window.location.search.substring(5).split(',');
        ...
        { 
		    ...
		    {  
		        ...
		        {
		         	var str1 = ","+removeIDs + ",";
		         	var str2 = "," + nodeIDs[i].toString().replace("\'","").replace("\'","") + ",";
        ...
        {        
            ...
            else
            {
                ...
                if(removeIDs !="")
                {
                    removeIDs = removeIDs+ "," + node.get_value();
                }
                else
                {
                    removeIDs =  node.get_value();
                }
            }
