<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectStrategyChapter.aspx.cs" Inherits="RailExamWebApp.Common.SelectStrategyChapter" %>
        ...
        function tvBookChapter_onNodeCheckChange(sender,eventArgs)
       {
        ...
        function selectBtnClicked()
        {
            if (window.location.search.indexOf("flag") > -1)
            {
                ...
                if (window.location.search.indexOf("flag=3") > -1 || window.location.search.indexOf("flag=4") > -1)
                {
...
<body>
    <form id="form1" runat="server">
        <div id="page">
            <div id="content">
                <div id="contentHead">
                    教材章节&nbsp;&nbsp;<img onclick="selectBtnClicked();" src="../Common/Image/confirm.gif" alt="" style="cursor:hand;" />
                </div>
                <div>
                    查看方式
