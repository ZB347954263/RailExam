<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="MultiSelectTrainType.aspx.cs" Inherits="RailExamWebApp.Common.MultiSelectTrainType" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            for(var i = 0; i < tvTrainType.get_nodes().get_length(); i ++)
            {
                var node = tvTrainType.get_nodes().getNode(i);
                check(node);
            }
    ...
    <form id="form1" runat="server">
        <div id="page">
            <div id="content">
                <div id="contentHead">
                    培训类别&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <img onclick="selectBtnClicked();" style="cursor:hand;" src="../Common/Image/confirm.gif" alt="" />
                 </div>
                <div id="mainContent">
