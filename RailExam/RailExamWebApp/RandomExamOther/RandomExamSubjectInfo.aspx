<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RandomExamSubjectInfo.aspx.cs" Inherits="RailExamWebApp.RandomExamOther.RandomExamSubjectInfo" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="overflow: auto; height: 316px">
                                <asp:GridView ID="Grid1" runat="server" DataKeyNames="RandomExamSubjectId" 
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="最大题数" Visible="false">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblMaxNum" runat="server" Text='<%# Bind("MaxItemCount") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:TemplateField> 
