<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssistBookChapter.aspx.cs" Inherits="RailExamWebApp.AssistBook.AssistBookChapter" %>
    ...
    <script type="text/javascript">
        ...
        else
       {
        ...
        function tvBookChapter_onNodeSelect(sender, eventArgs)
        {
            ...
            theFrame.location = "AssistBookChapterDetail.aspx?id=" + node.get_id()+"&BookID=" + node.get_value() + "&ParentID="+ node.get_id()+"&Mode="+str;
        }   
        ...
        function tvBookChapterMoveCallBack_onCallbackComplete(sender, eventArgs)
        {
            ...
            {
                tvBookChapterChangeCallBack.callback(tvBookChapter.get_selectedNode().get_id(), "MoveUp");
            }
            if(theItem && theItem.value == "下移")
            {
                tvBookChapterChangeCallBack.callback(tvBookChapter.get_selectedNode().get_id(), "MoveDown");
            }
...
<body onbeforeunload="logout();">
    ...
    <script type="text/javascript">
        ...
        var search = window.location.search;
        var str= search.substring(search.indexOf("Mode=")+5);  
        theFrame.location = "AssistBookChapterDetail.aspx?id="+tvBookChapter.get_nodes().getNode(0).get_id()+"&BookID="+ +tvBookChapter.get_nodes().getNode(0).get_value() + "&ParentID=0&Mode="+str;
