<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="TaskGradeMgmt.aspx.cs" Inherits="RailExamWebApp.Task.TaskGradeMgmt" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            var h = $("#query").height();
            var res = $("#mainContent").slideToggle("slow");
            if(_fHide)
            {
                $("#mainContent").height($("#mainContent").height() - h);
                _fHide = !_fHide;
            }
            else
            {
