<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RandomExamManageFourth.aspx.cs" Inherits="RailExamWebApp.RandomExam.RandomExamManageFourth" %>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="选择">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Common/Image/charge.gif" ToolTip="已参加考试！" Visible='<%#((","+ViewState["HasExamId"]+",").Contains(","+DataBinder.Eval(Container, "DataItem.EmployeeID")+",") ? true : false) %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
