<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RandomExamManage.aspx.cs" Inherits="RailExamWebApp.RandomExam.RandomExamManage" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">       
        function tvExamCategory_onNodeSelect(sender, eventArgs)
        {
            ...
            if(node)
            {            
                window.frames["ifExamManageInfo"].location = "RandomExamManageInfo.aspx?id="+ node.get_value();
                node.expand();  
            }
            else
            {
                window.frames["ifExamManageInfo"].location = "RandomExamManageInfo.aspx?id="+ tvExamCategory.get_nodes().getNode(0).get_value(); 
            }
        }       
            ...
            <div id="content">
                ...
                <div id="right">
                    <div id="rightContentWithNoHead">
                        <iframe id="ifExamManageInfo" src="RandomExamManageInfo.aspx?id=0" frameborder="0" scrolling="auto" class="iframe"></iframe>
                    </div>
                </div>
            </div>
