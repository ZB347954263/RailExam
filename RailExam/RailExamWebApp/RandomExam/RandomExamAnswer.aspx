<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RandomExamAnswer.aspx.cs"
    Inherits="RailExamWebApp.RandomExam.RandomExamAnswer" %>
                    ...
                    <table width="95%">
                        <tr>
                            <td id='ExamTitle' colspan="6">
                                <%=RailExamWebApp.Common.Class.PrjPub.GetRailName()%>铁路局职工培训考试试卷</td>
                        </tr>
                        <tr>
