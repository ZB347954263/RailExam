<%@ Page Language="C#" AutoEventWireup="true" Codebehind="AttendExamTitleNew.aspx.cs"
    Inherits="RailExamWebApp.RandomExam.AttendExamTitleNew" %>
...
<body onload="showTime()">
    ...
    <script type="text/javascript">
    	...
    	window.frames["ifExamInfo"].location = "AttendExamNew.aspx"+search; 
    </script>
