<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RandomExamApplyDetail.aspx.cs"
    Inherits="RailExamWebApp.RandomExam.RandomExamApplyDetail" %>
...
<body onload="loadGrid()">
    <form id="form1" runat="server">
                                    ...
                                    <ComponentArt:GridLevel DataKeyField="RandomExamApplyID">
                                        <Columns>
                                            <ComponentArt:GridColumn DataField="IsChecked" HeadingText="选择" ColumnType="CheckBox"
                                                AllowEditing="True" Width="80" DataType="System.Boolean" />
                                            <ComponentArt:GridColumn DataField="RandomExamApplyID" HeadingText="编号" Visible="false" />
                                            <ComponentArt:GridColumn DataField="EmployeeName" HeadingText="考生姓名" Width="80" />
                                            ...
                                            <ComponentArt:GridColumn DataField="ApplyStatusName" HeadingText="申请状态" Width="80" />
        ...
        <%--        <asp:ObjectDataSource ID="odsExams" runat="server" SelectMethod="GetRandomExamApplyByExamID"
            TypeName="RailExam.BLL.RandomExamApplyBLL">
            <SelectParameters>
