<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPost.aspx.cs" Inherits="RailExamWebApp.RandomExam.SelectPost" %>
    ...
    <form id="form1" runat="server">
        <div id="page">
            <div id="content">
                <div id="contentHead">
                    职名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" onclick="checkAllPost()" name="chkPost" />全选&nbsp;&nbsp;&nbsp;
