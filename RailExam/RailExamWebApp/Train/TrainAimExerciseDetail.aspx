<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="TrainAimExerciseDetail.aspx.cs"
    Inherits="RailExamWebApp.Train.TrainAimExerciseDetail" %>
            ...
            <ComponentArt:Grid ID="Grid1" runat="server" PageSize="7"
                ...
                <Levels>
                    <ComponentArt:GridLevel DataKeyField="PaperId">
                        <Columns>
                            ...
                            <ComponentArt:GridColumn DataField="PaperName" HeadingText="练习名称" />
                ...
                <ClientTemplates>
                    <ComponentArt:ClientTemplate ID="CTedit">
                        <a onclick="ManagePaper(##DataItem.getMember('PaperId').get_value()## )" title="预览练习"
                            href="#"><b>预览练习</b></a>&nbsp;
