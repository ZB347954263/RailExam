<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="TrainCourseCoursewareDetail.aspx.cs" Inherits="RailExamWebApp.Train.TrainCourseCoursewareDetail" %>
...
<body>
    <form id="form1" runat="server">
     <asp:FormView ID="fvTrainCourseCourseWare" runat="server" BorderStyle="Solid" GridLines="Both"
            HorizontalAlign="Left" DataSourceID="dsTrainCourseCourseware" Width="320px" DataKeyNames="TrainCourseCoursewareID">
            <EditItemTemplate>
        ...
        <asp:ObjectDataSource ID="dsTrainCourseCourseware" runat="server" DeleteMethod="DeleteTrainCourseCourseware"
            SelectMethod="GetTrainCourseCoursewareInfo" TypeName="RailExam.BLL.TrainCourseCoursewareBLL"
            UpdateMethod="UpdateTrainCourseCourseware" DataObjectTypeName="RailExam.Model.TrainCourseCourseware"
            EnableViewState="False">
            <DeleteParameters>
                <asp:QueryStringParameter DefaultValue="1" Name="TrainCourseCoursewareID" QueryStringField="id"
                    Type="Int32" />
            </DeleteParameters>
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="1" Name="TrainCourseCoursewareID" QueryStringField="id"
