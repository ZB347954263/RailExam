<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="BulletinList.aspx.cs" Inherits="RailExamWebApp.Online.Notice.BulletinList" %>
        ...
        <table width="1004" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="210" valign="top">
                        ...
                        <tr>
                            <td height="300" colspan="3" align="left" valign="top" class="kuang">
                                <div>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="NoticeID"
                                        AutoGenerateColumns="False" DataSourceID="odsNotice" ShowHeader="False"
                                        PageSize="14" BorderWidth="0px">
                                        <Columns>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="12%" bgcolor="#1082E9" style="height: 21px">
                                <img src="../image/dot02.jpg" width="26" height="21" /></td>
                            <td width="62%" align="left" valign="baseline" bgcolor="#1082E9" style="height: 21px">
                                <span class="style18">信息公告</span></td>
                            <td width="26%" align="center" valign="baseline" bgcolor="#1082E9" style="height: 21px">
                        ...
                        <tr>
                            <td height="300" colspan="3" align="left" valign="top" class="kuang">
                                <div>
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" DataKeyNames="BulletinID" 
                                        AutoGenerateColumns="False" DataSourceID="odsBulletin" ShowHeader="False"
                                        PageSize="14" BorderWidth="0px" >
                                        <Columns>
                                            <asp:TemplateField HeaderText="标题">
                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                            ...
                                            <table width="96%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="left" valign="top" class="size14">
                                                        <div>
                                                            <asp:ObjectDataSource ID="odsBulletinDetail" runat="server" SelectMethod="GetBulletins"
                                                                TypeName="RailExam.BLL.BulletinBLL">
                                                                <SelectParameters>
                                                                    <asp:Parameter DefaultValue="-1" Name="nNum" Type="Int32" />
                                                                </SelectParameters>
                                                            </asp:ObjectDataSource>
                                                            <asp:GridView ID="GridView3" runat="server" DataKeyNames="BulletinID" Width="100%"
                                                                AutoGenerateColumns="False" DataSourceID="odsBulletinDetail" ShowHeader="False"
                                                                AllowPaging="True" BorderWidth="0px" PageSize="27">
                                                                <Columns>
                                                                    <asp:HyperLinkField DataTextField="Title" DataTextFormatString="{0}" DataNavigateUrlFields="BulletinID"
                                                                        DataNavigateUrlFormatString="BulletinDetail.aspx?id={0}" Target="_blank" />
