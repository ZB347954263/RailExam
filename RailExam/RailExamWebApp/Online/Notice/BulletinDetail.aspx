<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="BulletinDetail.aspx.cs" Inherits="RailExamWebApp.Online.Notice.BulletinDetail" %>
                                    ...
                                    <tr>
                                        <td height="75" align="center">
                                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="35" align="center" class="style20"><%=ViewState["Title"].ToString() %></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <table width="95%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td align="center" class="size14" style="height: 23px"><p><%=ViewState["Content"].ToString() %></p></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
