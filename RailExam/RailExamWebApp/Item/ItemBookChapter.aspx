<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemBookChapter.aspx.cs" Inherits="RailExamWebApp.Item.ItemBookChapter" %>
        ...
        else
       {
        ...
        function tvBookChapter_onNodeSelect(sender, eventArgs)
        {
           ...
           // theItem.value = "";
            ...
            theFrame.location = "ItemBookChapterDetail.aspx?id=" + node.get_id()+"&BookID=" + node.get_value() + "&ParentID="+ node.get_id();
        }   
...
<body onbeforeunload="logout();">
        ...
        <div id="page">
            <div id="head">
                ...
                <div id="button">
                    ...
                    <img id="fvBookChapter_btnAdd" onclick="imgBtns_onClick(this);" src="../Common/Image/ImportItem.gif"
    ...
    <script type="text/javascript">
        var theFrame = window.frames["ifBookChapterDetail"]; 
        theFrame.location = "BookChapterDetail.aspx?id="+tvBookChapter.get_nodes().getNode(0).get_id()+"&BookID="+ +tvBookChapter.get_nodes().getNode(0).get_value() + "&ParentID=0";
