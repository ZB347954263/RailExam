<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="TaskAnswer.aspx.cs" Inherits="RailExamWebApp.Paper.TaskAnswer" %>
            ...
            <table width="95%">
                <tr>
                    <td align="center" style="width: 80%">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label runat="server" ID="labeltitle"></asp:Label></td>
                    <td align="right">
