<%@ Page Language="C#" AutoEventWireup="True" Codebehind="PaperStrategyItemThird.aspx.cs"
    Inherits="RailExamWebApp.Paper.PaperStrategyItemThird" %>
...
<head runat="server">
    ...
    <script type="text/javascript">    
		...
		{
		    window.frames["ifPaperStrategyItemCategoryInfo"].document.getElementById(btn.id).onclick();
		}
		...
		function add()
		{
          ...
          ctop=(screen.availHeight-520)*.5;             
			  ...
			  var id=   document.getElementById('lbType').value;	
		        var re= window.open("PaperStrategyItemFourth.aspx?mode=Insert&id="+id ,'PaperStrategyItemFourth',' Width=600px; Height=520px,status=false,left='+cleft+',top='+ctop+',resizable=no',true);		
				   re.focus(); 		
		...
		{ 
		    var id=   document.getElementById('lbType').value;
			window.frames["ifPaperStrategyItemCategoryInfo"].location = "PaperStrategyItemCategoryInfo.aspx?id=" + id;
		}    
            ...
            <div id="content">
                <table class="contentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <iframe id="ifPaperStrategyItemCategoryInfo" src="PaperStrategyItemCategoryInfo.aspx?id=<%= ViewState["value"].ToString() %>"
